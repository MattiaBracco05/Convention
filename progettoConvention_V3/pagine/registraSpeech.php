...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $argomento = ucfirst(strtolower($argomento));
        ...
        */
        ...
        $queryInserisciSpeech =
            "INSERT INTO Speech (Titolo, Argomento) 
            VALUES ('$titolo', '$argomento');";
        
        //Eseguo la query (controllo se lo speech esiste)
        if (Database :: eseguiQuery($queryInserisciSpeech)) {
            echo '<script>';
            echo 'document.addEventListener("DOMContentLoaded", function() {';
            echo '    Swal.fire({';
            echo '        icon: "success",';
            echo '        title: "Creazione completata!",';
            echo '        text: "Hai completato la creazione dello speech.",';
        ...
        //Altrimenti --> Messaggio di errore (nella creazione dello speech)
        else {
            echo '<script>';
            echo '    document.addEventListener("DOMContentLoaded", function() {';
            echo '        Swal.fire({';
