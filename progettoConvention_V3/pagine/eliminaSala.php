...
<?php
    ...
    if (isset($_GET['NomeSala'])) {
        ...
        $queryVerifica =
            ...
            FROM Programma
            WHERE NomeSala = '$varSala'";

        //Eseguo la query (verifico se ci sono programmi associati alla sala che voglio eliminare)
        ...
        if ($risultato) {
            ...
            if ($numProgrammi > 0) {
                ...
                echo '            text: "Impossibile eliminare la sala in quanto è ancora associata a dei programmi.",';
            ...
            //Altrimenti --> Non ci sono sale associate --> Procedo con l'eliminazione
                ...
                if (Database :: eseguiQuery($queryEliminaSala)) {
                    echo '<script>';
                    echo '    document.addEventListener("DOMContentLoaded", function() {';
                    echo '        Swal.fire({';
                    echo '            icon: "info",';
                    echo '            title: "Sala Eliminata!",';
                    echo '            text: "La sala è stata cancellata dal database.",';
                    echo '            confirmButtonColor: "#3085d6",';
                    echo '            confirmButtonText: "OK"';
                    echo '        }).then(function() {';
                    echo '            window.location.href = "./homeAdmin.php";';
